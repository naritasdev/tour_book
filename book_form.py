...
def add_request_from_db(request_name, request_email, request_date, request_requests): 
    with engine.connect() as conn:
        result = conn.execute(text("insert into request (request_name,request_email,request_date,request_requests) values (%s, %s, %s, %s) ", (request_name,request_email,request_date,request_requests)))
